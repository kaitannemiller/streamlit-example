...
style ="""
    ...
    <style>
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(1) > div > div > div > div,
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(1) > div > div > div > div > div,
        ...
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(1) > div > div > div > div > div > div,
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(1) > div > div > div > div > div > div > div,
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(1) > div > div > div > div > div > div > div > div,
    ...
    <style>
        ...
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div > div > div > div > div > div > div > div > div.e1tzin5v0 > div > div > label > div > p,
        ...
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div > div > div > div > div > div > div > div > div > label > div > p {
    ...
    <style>
        ...
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(2) > div > div > div > div > div > div > div > div.e1tzin5v0 > div,
        #root > div > div.withScreencast > div > div > div > section > div > div > div > div > div > div > ul > li > div > div.streamlit-expanderContent > div > div > div > div > div.epcbefy1:nth-child(2) > div > div > div > div > div > div > div > div.e1tzin5v0 > div > div,
